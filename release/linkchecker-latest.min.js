...
"","",function(a){function b(a,b){return[{label:"URL",linkCallback:function(a){return a.URL}},{label:"StatusCode",width:"9em"},{label:"Actions",width:"10em"}]}function e(a){a=lscache.get(a.FoundOnURL+"|"+a.URL);return void 0==a?!1:(new Date(Date.now())).toLocaleDateString()==(new Date(a)).toLocaleDateString()}function d(a){Object.keys(a).forEach(function(b){delete a[b]})}function f(a,b){delete b[a.FoundOnURL][a.URL];Object.keys(b[a.FoundOnURL])}var c=this;c.message="";c.on("mount",function(){lscache.setBucket("linkchecker");
